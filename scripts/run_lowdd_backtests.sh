...
run_strategy() {
    ...
    echo "$PROJECT_ID $BACKTEST_ID $NAME" >> /tmp/lowdd_backtests.txt
    echo ""
}

# Clear tracking file
> /tmp/lowdd_backtests.txt

# Run all three strategies
run_strategy "SmallCapLowDD_V1" "algorithms/strategies/smallcap_low_dd_v1.py"
sleep 5
run_strategy "SmallCapLowDD_V2" "algorithms/strategies/smallcap_low_dd_v2.py"
sleep 5
run_strategy "SmallCapLowDD_V3" "algorithms/strategies/smallcap_low_dd_v3.py"

echo "=== All backtests started ==="
echo "Tracking file: /tmp/lowdd_backtests.txt"
cat /tmp/lowdd_backtests.txt
