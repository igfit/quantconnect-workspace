"""
Clenow v62: Looser ATR Stop + Lower Momentum Threshold

Based on v39 (23.6% CAGR, 23.2% DD)
Changes:
- ATR multiplier: 2.6 (from 2.3) - ride trends longer
- Min momentum: 35 (from 45) - more trade opportunities
- Min rel strength: 8 (from 12) - more candidates
"""
...
class ClenowLooseStop(QCAlgorithm):

    MOMENTUM_LOOKBACK = 50
    TOP_N = 3
    MIN_MOMENTUM = 35  # Lower: more opportunities
    MIN_REL_STRENGTH = 8  # Lower: more candidates
    MIN_R_SQUARED = 0.50

    LEVERAGE = 1.0
    ATR_TRAILING_MULT = 2.6  # Looser: ride trends longer
    BEAR_EXPOSURE = 0.0
    MAX_PER_SECTOR = 1
