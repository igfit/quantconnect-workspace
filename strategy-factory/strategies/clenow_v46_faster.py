"""
Clenow v46: Faster Signals for Range-Bound Markets

v39 underperformed in 2015-2019 (16.5% vs 31.5% in 2020-2024).
Trying faster momentum lookback and lower thresholds to catch
more opportunities in range-bound markets.

Changes from v39:
- Momentum lookback: 42 days (was 50)
- MIN_MOMENTUM: 35 (was 45)
- MIN_REL_STRENGTH: 8 (was 12)
"""
...
class ClenowFaster(QCAlgorithm):

    MOMENTUM_LOOKBACK = 42  # Faster
    TOP_N = 3
    MIN_MOMENTUM = 35  # Lower threshold
    MIN_REL_STRENGTH = 8  # Lower threshold
    MIN_R_SQUARED = 0.50
