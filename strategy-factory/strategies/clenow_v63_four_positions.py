"""
Clenow v63: Four Positions

Based on v39 (23.6% CAGR, 23.2% DD)
Changes:
- 4 positions instead of 3 (25% each)
- Min momentum: 40 (from 45) - slightly more opportunities
- Lower position size to 25% each (1.0 / 4)
"""
...
class ClenowFourPositions(QCAlgorithm):

    MOMENTUM_LOOKBACK = 50
    TOP_N = 4  # 4 positions instead of 3
    MIN_MOMENTUM = 40  # Slightly lower
    MIN_REL_STRENGTH = 12
    MIN_R_SQUARED = 0.50
