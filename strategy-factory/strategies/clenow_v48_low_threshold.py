"""
Clenow v48: Very Low Thresholds

Hypothesis: The 2015-2019 period had smaller sector rallies (energy, biotech)
that were filtered out by high momentum thresholds. Lower thresholds might
capture these rotations.

Changes from v39:
- MIN_MOMENTUM: 30 (was 45)
- MIN_REL_STRENGTH: 5 (was 12)
- Keep sector diversification and bi-weekly rebalancing
"""
...
class ClenowLowThreshold(QCAlgorithm):

    MOMENTUM_LOOKBACK = 50
    TOP_N = 3
    MIN_MOMENTUM = 30  # Much lower
    MIN_REL_STRENGTH = 5  # Much lower
    MIN_R_SQUARED = 0.45  # Slightly lower
                ...
                if mom is not None and mom > 10:
                    ...
                    if rel_str is not None and rel_str > -5:
                        if not any(s == symbol for s, _ in candidates):
                            candidates.append((symbol, mom * (rsq or 0.4)))
