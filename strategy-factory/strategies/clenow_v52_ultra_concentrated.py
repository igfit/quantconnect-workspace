"""
Clenow v52: Ultra Concentrated (1 position)

Hypothesis: With only 1 position in the absolute best momentum stock,
we capture more of the upside from winners like NVDA.

Changes from v39:
- TOP_N = 1 (was 3)
- MAX_POSITION_SIZE = 0.95 (was 0.40)
- Keep sector diversification (effectively picks best sector)
"""
...
class ClenowUltraConcentrated(QCAlgorithm):
    ...
    MAX_POSITION_SIZE = 0.95  # Almost all capital in one stock
    ...
    def rebalance(self):
        ...
        top = [candidates[0]]  # Just take the #1 stock
