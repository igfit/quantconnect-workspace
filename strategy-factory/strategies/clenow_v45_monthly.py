"""
Clenow v45: v39 with Monthly Rebalancing

v39 is best at 23.6% CAGR, 23.2% DD with bi-weekly rebalancing.
Testing monthly rebalancing to see if less churn helps.
"""
...
class ClenowMonthly(QCAlgorithm):
