"""
Clenow v42: Optimized v39 for Higher CAGR

Based on v39 (23.6% CAGR, 23.2% DD) - our best broad universe result
Trying to push CAGR toward 30% while keeping DD below 30%

Changes from v39:
- Allow 2 per sector (less diversification = higher concentration)
- Lower rel strength threshold (more opportunities)
- Slightly faster momentum lookback (42 days)
"""
...
class ClenowOptimized(QCAlgorithm):

    MOMENTUM_LOOKBACK = 42  # Faster signals
    TOP_N = 3
    MIN_MOMENTUM = 40  # Lower to catch more opportunities
    ...
    BEAR_EXPOSURE = 0.0
    MAX_PER_SECTOR = 2  # Allow some concentration
    ...
    def initialize(self):
        ...
        # Bi-weekly (worked better than weekly)
        self.schedule.on(
    ...
    def rebalance(self):
        ...
        self.log(f"OPT: {', '.join([f'{s.value}' for s, _ in top])}")
