"""
Clenow v47: More Positions + Looser Stops

Hypothesis: In range-bound markets (2015-2019), having more positions
and looser stops allows capturing more sector rotations.

Changes from v39:
- TOP_N: 4 (was 3)
- ATR_TRAILING_MULT: 2.8 (was 2.3)
- MIN_MOMENTUM: 40 (was 45)
"""
...
class ClenowMorePositions(QCAlgorithm):

    MOMENTUM_LOOKBACK = 50
    TOP_N = 4  # More positions
    MIN_MOMENTUM = 40  # Lower threshold
    MIN_REL_STRENGTH = 10
    MIN_R_SQUARED = 0.50

    LEVERAGE = 1.0
    ATR_TRAILING_MULT = 2.8  # Looser stops
    BEAR_EXPOSURE = 0.0
    MAX_PER_SECTOR = 1
