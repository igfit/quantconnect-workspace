"""
Clenow Momentum v11: Leveraged for Target Returns

v10 achieved 22.5% CAGR with only 22.2% DD (excellent!)
v11: Leverage up to reach 30% CAGR target

With 22.2% base DD, we have room for ~1.35x leverage to stay under 30%
Using 1.4x leverage for target ~30% CAGR, ~31% DD
"""
...
class ClenowMTFv11(QCAlgorithm):
    ...
    # v11: Higher leverage
    LEVERAGE = 1.4  # Increased from 1.2
    MAX_PER_SECTOR = 3
