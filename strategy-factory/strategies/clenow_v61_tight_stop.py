"""
Clenow v61: Tighter ATR Stop

Based on v39 (23.6% CAGR, 23.2% DD)
Changes:
- ATR multiplier: 2.0 (from 2.3) - protect gains more aggressively
- No other changes
"""
...
class ClenowTightStop(QCAlgorithm):
    ...
    LEVERAGE = 1.0
    ATR_TRAILING_MULT = 2.0  # Tighter: 2.0 vs 2.3
    BEAR_EXPOSURE = 0.0
    MAX_PER_SECTOR = 1
