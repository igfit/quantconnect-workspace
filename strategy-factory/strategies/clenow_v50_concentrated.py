"""
Clenow v50: Higher Concentration (2 positions)

Hypothesis: With sector diversification already enforced, reducing to 2 positions
concentrates capital in the very best momentum stocks.

Changes from v39:
- TOP_N = 2 (was 3)
- MAX_POSITION_SIZE = 0.50 (was 0.40)
...
class ClenowConcentrated(QCAlgorithm):

    MOMENTUM_LOOKBACK = 50
    TOP_N = 2  # More concentrated
    MIN_MOMENTUM = 45
    MIN_REL_STRENGTH = 12
    MIN_R_SQUARED = 0.50
    ...
    MAX_POSITION_SIZE = 0.50  # Higher since fewer positions
