...
class SmaTrendAllcapDiversified(QCAlgorithm):
    """
    SMA Trend All-Cap Diversified

    SMA trend following across large, mid, and small caps

    Rationale: Combining large-cap stability with mid/small-cap growth potential. 50 SMA is the institutional standard for intermediate trend. Broad diversification across market caps and sectors. Simple trend rule: own when above 50 SMA, sell when below. No concentration in any single name or sector.

    Generated by Strategy Factory
    Strategy ID: sma_allcap_diversified
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["AAPL", "MSFT", "GOOGL", "AMZN", "META", "JPM", "V", "MA", "UNH", "JNJ", "WMT", "PG", "KO", "PEP", "COST", "CAT", "DE", "HON", "UNP", "RTX", "XOM", "CVX", "NEE", "DUK", "SO", "SMCI", "DECK", "AXON", "CROX", "FIVE", "AMD", "AVGO", "QCOM", "TXN", "MU", "CRM", "ADBE", "NOW", "SNOW", "PLTR"]:
        ...
        for symbol in self.symbols:
            ...
            self.indicators[symbol]['sma50'] = self.sma(symbol, 50, Resolution.DAILY)
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "price", "sma50"))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "price", "sma50"))
