...
class EmaTrendSectorBalanced(QCAlgorithm):
    """
    EMA Trend Sector Balanced

    EMA crossover with equal sector representation

    Rationale: Strictly balanced across 10 GICS sectors - 4 stocks per sector. Ensures no sector dominates returns. If tech crashes, other sectors provide buffer. If energy rallies, we capture it. True systematic diversification. 12/26 EMA for trend signals.

    Generated by Strategy Factory
    Strategy ID: ema_sector_balanced
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["AAPL", "MSFT", "NVDA", "CRM", "JPM", "GS", "V", "MA", "UNH", "JNJ", "PFE", "ABBV", "AMZN", "WMT", "HD", "COST", "XOM", "CVX", "COP", "SLB", "CAT", "HON", "UNP", "GE", "NEE", "DUK", "SO", "AEP", "PG", "KO", "PEP", "CL", "AMT", "PLD", "EQIX", "SPG", "LIN", "APD", "ECL", "SHW"]:
        ...
        # Indicator: ema_fast (EMA)
        for symbol in self.symbols:
            if symbol not in self.indicators:
                self.indicators[symbol] = {}
            self.indicators[symbol]['ema_fast'] = self.ema(symbol, 12, Resolution.DAILY)
        
        # Indicator: ema_slow (EMA)
        for symbol in self.symbols:
            if symbol not in self.indicators:
                self.indicators[symbol] = {}
            self.indicators[symbol]['ema_slow'] = self.ema(symbol, 26, Resolution.DAILY)
        

        # =================================================================
        # POSITION TRACKING
        # =================================================================
        self.position_size_dollars = 4000
        self.entry_prices = {}
        self.entry_dates = {}
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "ema_fast", "ema_slow"))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "ema_fast", "ema_slow"))
