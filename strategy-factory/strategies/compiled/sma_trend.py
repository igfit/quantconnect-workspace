...
class SmaTrendFollowing(QCAlgorithm):
    """
    SMA Trend Following

    Buy when price is above 50 SMA, sell when below. Simple trend following.

    Rationale: Simplest possible trend following. When price is above moving average, trend is up. Captures major trends without trying to time perfect entries. Works because trends persist due to institutional flows and behavioral momentum.

    Generated by Strategy Factory
    Strategy ID: sma_trend
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["SPY", "QQQ", "AAPL", "MSFT", "NVDA", "GOOGL"]:
