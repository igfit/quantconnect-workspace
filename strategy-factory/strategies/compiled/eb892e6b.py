...
class TechSectorMomentum(QCAlgorithm):
    ...
    Ride momentum in tech sector ETF using SMA crossover

    Rationale: Technology sector often leads bull markets. QQQ captures broad tech exposure with excellent liquidity. Simple trend following works well on sector ETFs.

    Generated by Strategy Factory
    Strategy ID: eb892e6b
    """
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "sma_20", "sma_50"))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "sma_20", "sma_50"))
