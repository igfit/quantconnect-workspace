...
class BollingerBandBounce(QCAlgorithm):
    ...
    Buy when price touches lower BB in uptrend, sell at middle band
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._get_indicator_value(symbol, "price") > self._get_indicator_value(symbol, "sma_50")) and (self._crosses_above(symbol, "price", "sma_20"))
