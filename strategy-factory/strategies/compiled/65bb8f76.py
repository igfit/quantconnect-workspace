...
class RsiOversoldBounce(QCAlgorithm):
    """
    RSI Oversold Bounce

    Buy when RSI indicates oversold, sell when overbought

    Rationale: RSI extremes often mark short-term reversals. The 200-day SMA filter ensures we only buy dips in uptrends, avoiding falling knives.

    Generated by Strategy Factory
    Strategy ID: 65bb8f76
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["TSLA", "NVDA", "AMD", "SQ", "COIN", "MARA"]:
        ...
        for symbol in self.symbols:
            ...
            self.indicators[symbol]['rsi_7'] = self.rsi(symbol, 7, Resolution.DAILY)
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._get_indicator_value(symbol, "rsi_7") < 25) and (self._get_indicator_value(symbol, "price") > self._get_indicator_value(symbol, "sma_200"))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._get_indicator_value(symbol, "rsi_7") > 70)
