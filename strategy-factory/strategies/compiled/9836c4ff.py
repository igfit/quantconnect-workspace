...
class DualEmaTrend(QCAlgorithm):
    """
    Dual EMA Trend

    Follow trend using fast/slow EMA crossovers

    Rationale: EMA responds faster to price changes than SMA. Dual EMA crossovers capture trend changes. Works well in trending markets.

    Generated by Strategy Factory
    Strategy ID: 9836c4ff
    """
