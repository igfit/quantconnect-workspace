...
class AdxTrendRider(QCAlgorithm):
    """
    ADX Trend Rider

    Enter strong trends (ADX > 25), exit when trend weakens

    Rationale: ADX measures trend strength regardless of direction. ADX > 25 indicates a strong trend worth riding. Combined with MA for direction confirmation.

    Generated by Strategy Factory
    Strategy ID: ef258d45
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["TSLA", "NVDA", "AMD", "AAPL", "MSFT", "GOOGL"]:
        ...
        # Indicator: ema_20 (EMA)
        for symbol in self.symbols:
            if symbol not in self.indicators:
                self.indicators[symbol] = {}
            self.indicators[symbol]['ema_20'] = self.ema(symbol, 20, Resolution.DAILY)
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._get_indicator_value(symbol, "adx_14") > 25) and (self._get_indicator_value(symbol, "price") > self._get_indicator_value(symbol, "ema_20"))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._get_indicator_value(symbol, "adx_14") < 20) or (self._crosses_below(symbol, "price", "ema_20"))
