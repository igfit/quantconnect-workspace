...
class HighBreakout(QCAlgorithm):
    """
    High Breakout

    Buy on new 20-day high, exit on new 10-day low

    Rationale: New highs indicate strong momentum and often lead to continuation. The asymmetric exit (10-day low vs 20-day high) lets winners run while cutting losers quickly.

    Generated by Strategy Factory
    Strategy ID: 81bfe619
    """
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._get_indicator_value(symbol, "price") > self._get_indicator_value(symbol, "sma_20"))
