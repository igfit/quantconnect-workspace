...
class TechSectorMomentum(QCAlgorithm):
    """
    Tech Sector Momentum

    Ride momentum in tech sector ETF

    Rationale: Technology sector often leads bull markets. XLK captures broad tech exposure with good liquidity. Simple trend following works well on sector ETFs.

    Generated by Strategy Factory
    Strategy ID: a1ef1427
    """
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "price", "sma_50")) and (self._get_indicator_value(symbol, "rsi_14") > 45)
