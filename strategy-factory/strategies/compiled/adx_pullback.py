...
class AdxTrendPullback(QCAlgorithm):
    """
    ADX Trend Pullback

    Buy pullbacks (RSI < 40) in trending markets (ADX > 20), exit when overbought

    Rationale: Pullbacks in trending markets offer better risk/reward than breakouts. ADX > 20 confirms a trend exists (not requiring strong trend). RSI < 40 times the entry at moderate pullback. Relaxed thresholds from original (ADX > 25, RSI < 35) for more signals.

    Generated by Strategy Factory
    Strategy ID: adx_pullback
    """
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._get_indicator_value(symbol, "adx_14") > 20) and (self._get_indicator_value(symbol, "rsi_14") < 40)
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._get_indicator_value(symbol, "rsi_14") > 70) or (self._get_indicator_value(symbol, "adx_14") < 15)
