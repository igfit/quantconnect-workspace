...
class RocMomentumRussellMidcap(QCAlgorithm):
    """
    ROC Momentum Russell Mid-Cap

    ROC momentum on Russell 2000/mid-cap growth stocks

    Rationale: Mid-cap stocks often have better momentum characteristics than large caps - more room to grow, less analyst coverage means slower price discovery. This universe includes Russell 2000 and S&P 400 mid-cap leaders across sectors. Testing if momentum works better on mid-caps where information advantage is larger.

    Generated by Strategy Factory
    Strategy ID: roc_russell_midcap
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["SMCI", "DECK", "CELH", "AXON", "TOST", "DUOL", "WING", "CAVA", "BROS", "SHAK", "CROX", "FIVE", "BOOT", "DKS", "PLNT", "RCL", "CCL", "MAR", "HLT", "WYNN", "MTCH", "RBLX", "TTWO", "EA", "NFLX", "PAYC", "PCTY", "WEX", "GPN", "FIS"]:
