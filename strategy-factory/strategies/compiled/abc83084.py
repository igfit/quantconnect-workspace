...
class BollingerBandBounce(QCAlgorithm):
    """
    Bollinger Band Bounce

    Buy at lower band, sell at middle or upper band

    Rationale: Bollinger Bands capture volatility-adjusted extremes. Price touching the lower band in an uptrend often bounces. Target the middle band for conservative exits.

    Generated by Strategy Factory
    Strategy ID: abc83084
    """
    ...
    def initialize(self):
        ...
        for symbol in self.symbols:
            ...
            self.indicators[symbol]['bb'] = self.bb(symbol, 20, 2, Resolution.DAILY)
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._get_indicator_value(symbol, "price") > self._get_indicator_value(symbol, "sma_50"))
