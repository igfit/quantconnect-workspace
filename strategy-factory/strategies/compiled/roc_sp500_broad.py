...
class RocMomentumSp500Broad(QCAlgorithm):
    """
    ROC Momentum S&P 500 Broad

    ROC momentum across 30 diversified S&P 500 stocks

    Rationale: Broad S&P 500 exposure across all major sectors. No single-name dependency - if one stock fails, others compensate. ROC(21) signal captures 1-month momentum which is proven academically. Diversification across Tech, Finance, Healthcare, Consumer, Industrial, Energy, Materials, Utilities. Target: systematic returns without concentration risk.

    Generated by Strategy Factory
    Strategy ID: roc_sp500_broad
    """
    ...
    def initialize(self):
        ...
        for symbol in self.symbols:
            ...
            self.indicators[symbol]['roc21'] = self.roc(symbol, 21, Resolution.DAILY)
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "roc21", 0))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "roc21", 0))
