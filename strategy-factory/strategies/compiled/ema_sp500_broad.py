...
class EmaTrendSp500Broad(QCAlgorithm):
    """
    EMA Trend S&P 500 Broad

    EMA crossover across 30 diversified S&P 500 stocks

    Rationale: 12/26 EMA crossover on broad S&P 500. Same diversified universe as ROC strategy but with trend-following signal instead of pure momentum. EMA crossover is slower/smoother than ROC, may reduce whipsaws. Testing which signal works better on diversified universe.

    Generated by Strategy Factory
    Strategy ID: ema_sp500_broad
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["AAPL", "MSFT", "GOOGL", "AMZN", "META", "NVDA", "JPM", "BAC", "GS", "MS", "WFC", "UNH", "JNJ", "PFE", "MRK", "ABBV", "WMT", "HD", "COST", "NKE", "SBUX", "CAT", "HON", "UNP", "GE", "BA", "XOM", "CVX", "COP", "PG", "KO"]:
        ...
        # POSITION TRACKING
        # =================================================================
        self.position_size_dollars = 5000
        self.entry_prices = {}
        self.entry_dates = {}
