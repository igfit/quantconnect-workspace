...
class VolatilityContractionBreakout(QCAlgorithm):
    """
    Volatility Contraction Breakout

    Buy when volatility contracts then price breaks out

    Rationale: Periods of low volatility (tight Bollinger Bands) often precede large moves. A breakout from consolidation with volume can signal the start of a new trend.

    Generated by Strategy Factory
    Strategy ID: 18ab70f8
    """
    ...
    def initialize(self):
        ...
        # Indicator: atr_14 (ATR)
        for symbol in self.symbols:
            if symbol not in self.indicators:
                self.indicators[symbol] = {}
            self.indicators[symbol]['atr_14'] = self.atr(symbol, 14, Resolution.DAILY)
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "price", "sma_20"))
