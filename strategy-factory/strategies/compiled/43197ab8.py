...
class TrendMomentumFilter(QCAlgorithm):
    """
    Trend + Momentum Filter

    Buy when price above SMA and RSI confirms momentum

    Rationale: Combining trend (price > MA) with momentum (RSI) provides double confirmation. Only trades with the trend when momentum supports it.

    Generated by Strategy Factory
    Strategy ID: 43197ab8
    """
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "price", "sma_50")) and (self._get_indicator_value(symbol, "rsi_14") > 50)
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "price", "sma_50")) or (self._get_indicator_value(symbol, "rsi_14") < 40)
