...
class HighBetaTrend(QCAlgorithm):
    """
    High Beta Trend

    Trend following on high-beta growth stocks

    Rationale: High-beta stocks move more than the market. In uptrends, they outperform significantly. Key is to ride trends and exit quickly when they end.

    Generated by Strategy Factory
    Strategy ID: 245d9df3
    """
    ...
    def initialize(self):
        ...
        self.symbols = []
        # Static universe
        for ticker in ["TSLA", "NVDA", "AMD", "COIN", "SQ", "SHOP", "MARA", "RIOT"]:
        ...
        # Indicator: ema_10 (EMA)
        for symbol in self.symbols:
            if symbol not in self.indicators:
                self.indicators[symbol] = {}
            self.indicators[symbol]['ema_10'] = self.ema(symbol, 10, Resolution.DAILY)
        
        # Indicator: ema_30 (EMA)
        for symbol in self.symbols:
            if symbol not in self.indicators:
                self.indicators[symbol] = {}
            self.indicators[symbol]['ema_30'] = self.ema(symbol, 30, Resolution.DAILY)
    ...
    def _check_entry_conditions(self, symbol) -> bool:
        ...
        """
        return (self._crosses_above(symbol, "ema_10", "ema_30"))
    ...
    def _check_exit_conditions(self, symbol) -> bool:
        ...
        GENERATED CODE - DO NOT EDIT
        """
        return (self._crosses_below(symbol, "ema_10", "ema_30"))
