"""
Clenow v64: Concentrated - 2 Positions, No Sector Limit

Based on v39 (23.6% CAGR, 23.2% DD)
Changes:
- 2 positions instead of 3 (50% each)
- Remove sector diversification (MAX_PER_SECTOR = 2)
- Higher position size (0.50)
- Keep broader universe for robustness

Hypothesis: Concentration drives returns, even with broad universe
"""
...
class ClenowConcentrated(QCAlgorithm):
    ...
    BEAR_EXPOSURE = 0.0
    MAX_PER_SECTOR = 2  # Remove sector limit effectively

    ATR_PERIOD = 20
    USE_ATR_TRAILING = True
    MAX_POSITION_SIZE = 0.50  # 50% each position
    ...
    def rebalance(self):
        ...
        # No sector limit - just pick top 2
