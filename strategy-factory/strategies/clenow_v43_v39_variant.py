"""
Clenow v43: v39 with 2 per sector

v39 (23.6% CAGR, 23.2% DD) is our best.
Only change: MAX_PER_SECTOR = 2 (was 1)

This allows more concentration in top-performing sectors.
"""
...
class ClenowV39Variant(QCAlgorithm):

    # EXACT same as v39 except MAX_PER_SECTOR
    ...
    BEAR_EXPOSURE = 0.0
    MAX_PER_SECTOR = 2  # Changed from 1
    ...
    def rebalance(self):
        ...
        self.log(f"V43: {', '.join([f'{s.value}({self.get_sector(s)})' for s, _ in top])}")
