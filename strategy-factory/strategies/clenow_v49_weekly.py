"""
Clenow v49: Weekly Rebalancing

Hypothesis: Bi-weekly rebalancing might miss quick momentum shifts.
Weekly rebalancing could capture sector rotations faster.

Changes from v39:
- Weekly rebalancing (not bi-weekly)
...
class ClenowWeekly(QCAlgorithm):
