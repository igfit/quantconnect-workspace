...
class EMADynamicAnnualV75Test(QCAlgorithm):
    """
    V75: V74 but remove regime update from coarse_filter

    Only difference from V72: keeps get_current_regime() method
    """
    ...
    def get_current_regime(self):
        # Keep this method but don't use it for updates
    ...
    def coarse_filter(self, coarse):
        # NO regime update - just use fixed current_regime
