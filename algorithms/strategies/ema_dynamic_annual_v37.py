...
class EMADynamicAnnualV37(QCAlgorithm):
    """
    V37: HYBRID - TRAILING STOP + LIGHT PROFIT TAKING

    Combine best elements:
    - 27% trailing stop (between V34's 30% and V35's 25%)
    - Light profit taking: 25% at 100% gain
    - 6 positions @ 18% (108% exposure, slightly less than V34)
    ...
    def initialize(self):
        ...
        # Middle-ground trailing stop
        self.trailing_stop_pct = 0.27

        # Light profit taking
        self.profit_take_threshold = 1.00  # 100% gain
        self.profit_take_amount = 0.25     # Sell 25%
    ...
    def on_data(self, data):
        ...
        for symbol in list(self.current_universe | self.held_symbols):
            ...
            if symbol in self.held_symbols:
                ...
                # Light profit taking at 100% gain
