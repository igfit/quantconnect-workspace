"""
Momentum Strategy: Fast Regime Filter

ITERATION: Test if faster regime detection improves returns
- Use 50 SMA instead of 200 SMA for SPY
- Exits bear markets faster, but may have more whipsaws
- Hypothesis: Avoid more drawdown, but risk missing rebounds
"""

from AlgorithmImports import *


class MomentumFastRegime(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.regime_sma_period = 50  # FASTER than 200
        self.top_n = 10
