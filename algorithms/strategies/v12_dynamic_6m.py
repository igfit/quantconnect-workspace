"""
v12 Dynamic Universe - Refresh every 6 MONTHS

Selects high-beta growth stocks and refreshes the universe twice per year.
"""

from AlgorithmImports import *


class V12Dynamic6M(QCAlgorithm):
    ...
    def fine_filter(self, fine):
        ...
        self.log(f"Universe refreshed (6M): {len(selected)} stocks at {self.time.date()}")
