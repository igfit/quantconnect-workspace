"""
v12 Robustness Test - Without NVDA and TSLA
Testing if strategy works without the top performers.
"""

from AlgorithmImports import *


class V12NoNvdaTsla(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # ROBUSTNESS TEST: Remove NVDA and TSLA (top performers)
        ...
        self.log(f"Universe size (no NVDA/TSLA): {len(self.symbols)} stocks")
