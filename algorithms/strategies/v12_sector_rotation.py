"""
v12 SECTOR ROTATION Strategy

Instead of picking stocks directly, first identify the
LEADING SECTORS, then pick top momentum stocks within those sectors.

Process:
1. Rank sectors by 3-month momentum using sector ETFs
2. Focus on top 2-3 sectors
3. Within those sectors, pick top momentum stocks
4. Standard regime filter

This adapts because:
- 2015-2019: Tech led → pick FAANG
- 2020-2024: Tech/Semis led → pick NVDA, AMD
"""

from AlgorithmImports import *


class V12SectorRotation(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.sector_lookback = 63  # 3 months for sector rotation
        self.top_n = 8
        ...
        self.active_symbols = []
        self.stock_sectors = {}  # Map stock to sector
        self.momentum = {}
        self.short_mom = {}
        self.volume_sma = {}
    ...
    def get_leading_sectors(self):
        """Identify top 3 sectors by momentum."""
        sector_scores = []
    ...
    def coarse_filter(self, coarse):
        ...
        # Update leading sectors
        self.leading_sectors = self.get_leading_sectors()
        self.log(f"Leading sectors: {self.leading_sectors}")
    ...
    def fine_filter(self, fine):
        ...
        # Filter to leading sectors only
        ...
        # Take top by dollar volume within leading sectors
        ...
        self.log(f"Universe (sector rotation): {len(selected)} stocks in {len(self.leading_sectors)} sectors")
