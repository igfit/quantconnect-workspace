...
class PositionCentricV35Year2025(QCAlgorithm):
    """
    V35 No Leverage: 2025 Forward Test

    Testing the strategy on 2025 data (forward/live validation).
    Uses 250-day warmup to ensure all indicators ready by Jan 1, 2025.
    """
    ...
    def get_position_weight(self):
        ...
        # Still reduce in bear markets, but max is 1x
        ...
        if above_200:
            return 1.0 / self.max_positions  # ~33% per position
        else:
            return 0.8 / self.max_positions  # ~27% per position in bear markets
