...
class VixFilteredMomentumNoNVDA(QCAlgorithm):
    """
    VIX-Filtered Momentum - WITHOUT NVDA (robustness test)

    Original achieved 33.05% CAGR, 1.109 Sharpe, 22.9% DD WITH NVDA.
