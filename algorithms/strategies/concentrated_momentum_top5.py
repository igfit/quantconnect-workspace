...
class ConcentratedMomentumTop5(QCAlgorithm):
    """
    Concentrated Momentum Top 5 Strategy

    Hypothesis: Top 5 instead of Top 3 may reduce drawdown
    while still capturing most of the upside.

    Signal: 6-month return > SPY, Price > 50 SMA
    Positions: Top 5 stocks (20% each)
    Rebalance: Monthly
    """
    ...
    def initialize(self):
        ...
        # === PARAMETERS ===
        self.num_positions = 5  # Less concentrated than Top 3
