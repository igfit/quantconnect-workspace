...
class DrawdownScalingSmallCap(QCAlgorithm):
    """
    Drawdown-Based Position Scaling - Small/Mid Cap Universe

    Tests if DD scaling works without TSLA/NVDA/MSTR bias.
    Same logic as DrawdownScaling but on small-cap speculative stocks.
    """
