...
class MidCapLowDDSameRules(QCAlgorithm):
    """
    Mid-Cap with SAME DD reduction rules as LargeCapLowDD

    Testing if DD reduction techniques work on the mid-cap universe
    that previously FAILED (Sharpe 0.045).

    Uses IDENTICAL risk parameters as LargeCapLowDD.
    """
    ...
    def initialize(self):
        ...
        # Mid-Cap Universe (SAME as ResidualMidCapR18)
        self.tickers = [
            # Tech Mid-Caps
            "TWLO", "OKTA", "ZM", "DOCU", "SPLK",
            "ESTC", "HUBS", "TTD", "VEEV", "PAYC",
            # Semiconductors Mid-Caps
            "SWKS", "QRVO", "MPWR", "WOLF", "ON",
            # Consumer/Retail
            "ETSY", "W", "CHWY", "DASH", "LYFT",
            # Healthcare Growth
            "TDOC", "EXAS", "INSP", "ALGN", "DXCM",
        ]
