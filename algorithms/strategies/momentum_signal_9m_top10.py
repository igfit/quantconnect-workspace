"""
Momentum Signal Test: 9-month lookback, Top 10 positions
Longer lookback captures bigger trends, concentrated positions
"""

from AlgorithmImports import *


class MomentumSignal9mTop10(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # PARAMETERS
        self.lookback_days = 189          # 9 months
        self.top_n = 10
