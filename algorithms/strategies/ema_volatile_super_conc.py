...
class EMAVolatileSuperConc(QCAlgorithm):
    """
    EMA Crossover - Super Concentrated (8 positions at 12.5% each)

    Even more concentrated for higher returns
    """
    ...
    def initialize(self):
        ...
        self.max_positions = 8  # Super concentrated
