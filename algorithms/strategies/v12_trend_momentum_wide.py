"""
v12 TREND + MOMENTUM Strategy - WIDE UNIVERSE

Same trend+momentum approach but with wider market cap range
to capture both FAANG (2015-2019) and semis (2020-2024).

Market cap: $10B - $2T (mega-caps included)
"""

from AlgorithmImports import *


class V12TrendMomentumWide(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # WIDE UNIVERSE - include mega-caps
        self.universe_size = 100
        self.min_market_cap = 10e9     # $10B
        self.max_market_cap = 2000e9   # $2T - include mega-caps
        self.min_price = 20
    ...
    def fine_filter(self, fine):
        ...
        # Exclude defensive sectors only
        excluded_sectors = [
        ...
        self.log(f"Wide trend momentum universe: {len(selected)} stocks at {self.time.date()}")
