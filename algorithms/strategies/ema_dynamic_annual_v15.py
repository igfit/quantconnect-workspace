...
class EMADynamicAnnualV15(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V15 MORE DIVERSIFICATION

    More positions = natural risk reduction:
    - 8 positions at 12.5% each = 100% exposure
    - No DD control needed - diversification handles it
    - Same EMA signals as V5
    ...
    def initialize(self):
        ...
        # More diversification: 8 positions @ 12.5%
