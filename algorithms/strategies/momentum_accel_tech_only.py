"""
Momentum Strategy: Tech-Only Universe

TEST: Does focusing on tech stocks (highest momentum potential) improve returns?
Universe: Semiconductors + Software only (28 stocks)
"""

from AlgorithmImports import *


class MomentumAccelTechOnly(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # TECH-ONLY UNIVERSE: Semiconductors + Software (28 stocks)
