...
class EMAUltraConcentrated(QCAlgorithm):
    """
    Ultra Concentrated - 6 positions at 16.67% each

    Maximum concentration for highest potential returns
    """
    ...
    def initialize(self):
        ...
        self.max_positions = 6  # Ultra concentrated
        self.weight_per_stock = 0.1667  # ~16.67% each
