...
class ShortMomentumLeveredOOS(QCAlgorithm):
    """
    OUT-OF-SAMPLE TEST: 2015-2020 (before original backtest period)

    Tests if strategy works in different market regime.
    """

    def initialize(self):
        # OUT-OF-SAMPLE: 2015-2020
        ...
        # Same universe (some may not have data pre-2020)
