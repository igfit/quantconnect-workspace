...
class EMADynamicAnnualV41(QCAlgorithm):
    """
    V41: MORE DIVERSIFICATION

    More positions = natural DD reduction through diversification.
    - 7 positions @ 16% = 112% exposure
    - 30% trailing stop
    - 80th percentile volatility (same as V40)
