...
class EMADynamicAnnualV26(QCAlgorithm):
    """
    V26: V8 EXACT SETTINGS AT 1X LEVERAGE

    Exact same as V8 which got 27.5% CAGR but:
    - 5 positions at 20% = 100% exposure (not 120%)
    - Expected: ~23% CAGR (27.5% * 5/6)
    """
    ...
    def fine_filter(self, fine):
        ...
        # Above-median volatility (same as V8)
