...
class EMADynamicAnnualV71Test(QCAlgorithm):
    """
    V71: V58 with FIXED regime dates (2020-2025 test)

    Fix: Extended SPECULATIVE_BULL end date to 2029-12-31 to cover
    the January 2025 universe refresh.
    """
    ...
    def initialize(self):
        ...
        self.regime_dates = [
            ...
            (datetime(2020, 1, 1), datetime(2029, 12, 31), "SPECULATIVE_BULL"),  # FIXED!
        ]
