...
class RegimeConcentratedMomentumNoNVDA(QCAlgorithm):
    """
    Regime + Concentrated Momentum - WITHOUT NVDA (robustness test)

    Original achieved 39.53% CAGR, 1.036 Sharpe WITH NVDA.
