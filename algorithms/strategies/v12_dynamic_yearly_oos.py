"""
v12 Dynamic Universe - Refresh YEARLY - OOS TEST (2015-2019)

Out-of-sample validation of the dynamic universe strategy.
"""

from AlgorithmImports import *


class V12DynamicYearlyOOS(QCAlgorithm):

    def initialize(self):
        # OOS PERIOD: 2015-2019
    ...
    def fine_filter(self, fine):
        ...
        self.log(f"Universe refreshed (YEARLY): {len(selected)} stocks at {self.time.date()}")
