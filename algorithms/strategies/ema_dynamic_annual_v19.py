...
class EMADynamicAnnualV19(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V19 DD CONTROL + PROFIT + MODERATE LEVERAGE

    Best of V14 with slight leverage boost:
    - 6 positions at 18% each = 108% exposure
    - DD control: reduce at 20%, exit at 30% (looser than V14)
    - Take 50% profit at 35% gain
    - 12% trailing stop after profit take
    ...
    def initialize(self):
        ...
        self.dd_exit_threshold = 0.30
        self.dd_reentry_threshold = 0.12
