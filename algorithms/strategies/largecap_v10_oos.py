...
class LargeCapV10OOS(QCAlgorithm):
    """
    Large-Cap V10: OUT-OF-SAMPLE TEST (2015-2020)

    Same logic as LargeCapV10 but tested on 2015-2020 period.
    Universe adjusted: Removed COIN (IPO'd 2021).
    """
    ...
    def initialize(self):
        ...
        # Same parameters as LargeCapV10
        self.short_lookback = 30
        self.long_lookback = 84
        self.beta_lookback = 126
        self.rs_lookback = 21

        # Large-Cap High-Beta Universe (removed COIN - didn't exist)
        self.tickers = [
