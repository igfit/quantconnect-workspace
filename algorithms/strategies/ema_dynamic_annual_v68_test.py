...
class EMADynamicAnnualV68Test(QCAlgorithm):
    """
    V68: V67 WITHOUT the fallback

    V67 had: if not selected: selected = stock_metrics
    V68 removes that fallback to match V30's behavior
    """
    ...
    def fine_filter(self, fine):
        ...
        # Regime-specific volatility but NO FALLBACK
        ...
        # NO FALLBACK - use high_vol directly like V30
