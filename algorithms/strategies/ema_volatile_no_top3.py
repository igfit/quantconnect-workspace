...
class EMAVolatileNoTop3(QCAlgorithm):
    """
    EMA Crossover Concentrated - Robustness Test

    Same as EMA Concentrated but WITHOUT top 3 performers:
    - BNTX (removed)
    - AFRM (removed)
    - HOOD (removed)
    """
