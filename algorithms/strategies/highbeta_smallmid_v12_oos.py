"""
High-Beta Small/Mid Cap v12 - OUT OF SAMPLE TEST (2015-2019)

Testing v12 strategy on different time period to verify robustness.
In-sample (2020-2024): 35.9% CAGR, 0.95 Sharpe, 29.9% DD
"""

from AlgorithmImports import *


class HighBetaSmallMidV12OOS(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # Same parameters as v12
        self.lookback_days = 126
        self.accel_period = 21
        self.top_n = 8
        self.max_leverage = 1.15
        self.min_dollar_volume = 5_000_000

        self.prev_short_mom = {}
        self.rebalance_week = 0

        # Same universe - but some stocks may not exist in 2015
        # Removed: CRWD (2019 IPO), UBER (2019 IPO), SNOW, DDOG, etc.
        self.universe_tickers = [
            "TSLA", "NVDA", "AMD",
            "MU", "MRVL", "ON", "SWKS", "AMAT", "LRCX", "KLAC",
            "ZS", "OKTA", "TWLO", "NET", "MDB",  # Some may fail
            "SQ", "PYPL",
