...
class EMADynamicAnnualV30OOS(QCAlgorithm):
    """
    V30 OUT-OF-SAMPLE TEST (2015-2020)

    Same strategy as V30, testing on earlier period to validate robustness.
    """

    def initialize(self):
        # OOS period: 2015-2020
