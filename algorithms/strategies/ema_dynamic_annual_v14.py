...
class EMADynamicAnnualV14(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V14 DD CONTROL + PROFIT TAKING

    Combines V10's drawdown control with V12's profit taking:
    - 5 positions at 20% each = 100% exposure
    - DD control: reduce at 15%, exit at 25%
    - Take 50% profit at 40% gain
    - 15% trailing stop after profit take

    Target: 20%+ CAGR with <30% DD
    """
