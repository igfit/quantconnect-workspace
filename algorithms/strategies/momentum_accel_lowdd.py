...
class MomentumAccelLowDD(QCAlgorithm):
    """
    Momentum Acceleration + DD Reduction

    Only enter when momentum is ACCELERATING:
    - Short-term residual momentum > Long-term residual momentum
    - Combined with all LargeCapLowDD risk controls
    """
