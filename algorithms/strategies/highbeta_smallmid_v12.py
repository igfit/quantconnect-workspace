"""
High-Beta Small/Mid Cap v12 - REFINED (based on v11 success)

v11 achieved: 34.8% CAGR, 0.89 Sharpe, 32.9% DD
Target: 30% CAGR, 20-30% DD

Changes from v11:
- Reduce leverage to 1.15x (from 1.2x)
- Top 8 positions (from 7) for more diversification
- Add extra safety: exit individual positions if short-term mom < -15%
"""

from AlgorithmImports import *


class HighBetaSmallMidV12(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.top_n = 8            # More diversification
        self.max_leverage = 1.15  # Reduced leverage
    ...
    def rebalance(self):
        ...
        # Also exit individual positions with very weak short-term momentum
        ...
        for symbol in self.symbols:
            ...
            # Skip if short-term momentum is very negative
            if short_mom < -10:
                continue
