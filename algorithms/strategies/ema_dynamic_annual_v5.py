...
class EMADynamicAnnualV5(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V5 ULTRA CONCENTRATED

    Key insight: V2's 20/100 EMAs work well. V4's faster EMAs failed.

    Changes from V2:
    - Ultra concentrated: 5 positions at 20% each
    - Priority entry: when multiple signals, pick highest momentum
    - Keep 20/100 EMAs that worked
    ...
    def initialize(self):
        ...
        self.weight_per_stock = 0.20  # 20% each

        # Keep winning EMAs from V2
        self.ema_fast = 20
        self.ema_slow = 100

        # Store momentum scores for priority
    ...
    def fine_filter(self, fine):
        ...
        # Store momentum scores for priority entry
    ...
    def on_data(self, data):
        ...
        # Collect all entry signals with their momentum scores
        entry_candidates = []
