...
class EMADynamicAnnualV59QualityTest(QCAlgorithm):
    """
    V59: TEST QUALITY_BULL UNIVERSE ON 2015-2019

    Purpose: Validate that quality momentum works in normal bull markets.

    QUALITY_BULL Universe:
    - Large cap only (>$10B)
    ...
    Test period: 2015-2019 only

    Target: Beat V30's -3.4% CAGR in this period.
    Ideal: Match or beat SPY (~11% CAGR in 2015-2019)
    """

    def initialize(self):
        self.set_start_date(2015, 1, 1)
        self.set_end_date(2020, 1, 1)  # 2015-2019 only
        ...
        self.min_market_cap = 10e9  # Large cap
    ...
    def fine_filter(self, fine):
        ...
        for x in fine:
            try:
                ...
                # Require positive dual momentum
