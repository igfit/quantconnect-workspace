...
class PositionCentricV35NoLeverage(QCAlgorithm):
    """
    V35 No Leverage: Same as V35 but capped at 1x leverage

    Testing if the strategy works without leverage amplification.
    """
