"""
v12 Dynamic Universe - Select ONCE at start of backtest

Selects high-beta growth stocks once at the beginning and holds that universe.
This tests if the strategy works without hindsight in universe selection.
"""

from AlgorithmImports import *


class V12DynamicOnce(QCAlgorithm):
    ...
    def fine_filter(self, fine):
        ...
        # Prefer growth sectors (proxy for high-beta)
        growth_sectors = [
        ...
        self.log(f"Universe selected ONCE: {len(selected)} stocks at {self.time.date()}")
