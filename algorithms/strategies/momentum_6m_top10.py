"""
Momentum Signal: 6-month lookback, Top 10 positions (baseline params with more concentration)
"""

from AlgorithmImports import *


class Momentum6mTop10(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.lookback_days = 126          # 6 months (best so far)
        self.top_n = 10                   # More concentrated
