"""
High-Beta Small/Mid Cap Momentum Strategy v3

Changes from v1:
- Equal weight allocation (simpler, less concentration risk)
- Only 8 stocks for more concentration
- Stricter acceleration filter (must be positive)
"""

from AlgorithmImports import *


class HighBetaSmallMidV3(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # Parameters - MORE CONCENTRATED
        self.lookback_days = 126
        self.accel_period = 21
        self.top_n = 8            # More concentrated
    ...
    def rebalance(self):
        ...
        for symbol in self.symbols:
            ...
            # STRICT: require both positive momentum AND acceleration
