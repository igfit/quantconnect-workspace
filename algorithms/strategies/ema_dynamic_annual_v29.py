...
class EMADynamicAnnualV29(QCAlgorithm):
    """
    V29: V27 + LIGHTER PROFIT TAKING

    V28 reduced DD to 38% but lost too much CAGR (21% vs 35%).
    Making profit taking less aggressive:
    - Take 33% profit at 75% gain (vs 50% at 50%)
    - 20% trailing stop after profit take (vs 15%)
    ...
    def initialize(self):
        ...
        # Lighter profit taking
        self.profit_take_threshold = 0.75  # Was 0.50
        self.profit_take_amount = 0.33     # Was 0.50
        self.trailing_stop_pct = 0.20      # Was 0.15
    ...
    def on_data(self, data):
        ...
        for symbol in list(self.current_universe | self.held_symbols):
            ...
            if symbol in self.held_symbols:
                ...
                # Trailing stop (after profit taken)
