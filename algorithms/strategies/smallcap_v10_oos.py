...
class SmallCapV10OOS(QCAlgorithm):
    """
    Small-Cap V10: OUT-OF-SAMPLE TEST (2015-2020)

    Same logic as SmallCapV10 but tested on 2015-2020 period.
    Universe adjusted for stocks that existed during this period.

    Note: Many 2020-2024 small-caps (SOFI, HOOD, RIVN, etc.) didn't exist
    in 2015-2020, so we use comparable high-beta mid-caps from that era.
    """
    ...
    def initialize(self):
        ...
        # Same parameters as SmallCapV10
        self.short_lookback = 30
        self.long_lookback = 84
        self.beta_lookback = 126
        self.rs_lookback = 21

        # OOS Universe: High-beta mid/small-caps that existed in 2015-2020
        self.tickers = [
            # Clean Energy (existed)
            "PLUG", "FCEL",
            # Fintech/Payments
            "SQ", "PYPL",
            # Cloud/SaaS (IPO dates: TWLO Jun'16, SHOP May'15, TTD Sep'16)
            "TWLO", "SHOP", "TTD", "SPLK",
            # Consumer Tech (ROKU Sep'17, SNAP Mar'17, ETSY Apr'15)
            "ROKU", "SNAP", "ETSY", "W",
            # Security/Data (OKTA Apr'17, MDB Oct'17, ZS Mar'18)
            "OKTA", "MDB", "ZS",
            # China Tech (existed)
            "BIDU", "JD", "NTES",
            # Other high-beta
