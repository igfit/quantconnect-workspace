...
class ShortMomentum(QCAlgorithm):
    """
    Round 10 Strategy 4: Short-Term Momentum (3-month lookback)

    THESIS: Shorter 63-day (3-month) momentum captures recent winners faster
    than 126-day (6-month). May catch breakouts earlier.

    WHY IT MIGHT WORK:
    - 3-month momentum is more responsive to recent trends
    - Catches winners earlier in their run
    - Tech stocks can have rapid momentum shifts

    RISK FACTORS:
    - More noise in shorter timeframe
    - May chase short-term spikes
    - Higher turnover
    ...
    def initialize(self):
        ...
        for ticker in self.universe_tickers:
            ...
            # 63-day (3-month) momentum instead of 126-day
