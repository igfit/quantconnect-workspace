...
class ResidualMidCapR18(QCAlgorithm):
    """
    Round 18 Strategy 3: Residual Momentum on Established Mid-Caps

    More established mid-cap names that have longer price history.
    Mix of growth and value mid-caps with high beta.

    Universe: S&P 400 MidCap + high-beta growth names
    """
    ...
    def initialize(self):
        ...
        # Established Mid-Cap High-Beta Universe
        self.tickers = [
            # Tech Mid-Caps
            "TWLO",    # Twilio
            "OKTA",    # Okta
            "ZM",      # Zoom
            "DOCU",    # DocuSign
            "SPLK",    # Splunk (acquired but had data)
            "ESTC",    # Elastic
            "HUBS",    # HubSpot
            "TTD",     # Trade Desk
            "VEEV",    # Veeva Systems
