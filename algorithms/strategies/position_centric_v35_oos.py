...
class PositionCentricV35OOS(QCAlgorithm):
    """
    V35 No Leverage - Out of Sample Test (2015-2019)

    Testing if the strategy works on data before the optimization period.
    """

    def initialize(self):
        # OUT OF SAMPLE: 2015-2019
        self.set_start_date(2015, 1, 1)
        self.set_end_date(2019, 12, 31)
        self.set_cash(100000)

        # Same parameters as V35 no leverage
        ...
        self.entry_mom_6m = 0.25
        self.entry_mom_3m = 0.10
