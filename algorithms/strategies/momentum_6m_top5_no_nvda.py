"""
Momentum Signal: 6-month lookback, Top 5 positions (ROBUSTNESS TEST: No NVDA)
"""

from AlgorithmImports import *


class Momentum6mTop5NoNvda(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # PARAMETERS - 6m with Top 5 (highly concentrated)
        self.lookback_days = 126          # 6 months
        self.top_n = 5                    # Very concentrated
        self.use_regime_filter = True
        self.min_dollar_volume = 5_000_000

        # CLAUDE V3 UNIVERSE - NO NVDA (robustness test)
        self.universe_tickers = [
            "AMD", "AVGO", "QCOM", "MU", "AMAT", "LRCX", "KLAC", "MRVL", "ON",  # No NVDA
