...
class MomentumSectorOptimal(QCAlgorithm):
    """
    Sector ETF Momentum - Optimized Version

    Best parameters from sweep:
    - 1 month lookback (faster reaction)
    - Top 3 holdings (concentrated)
    - With regime filter for lower drawdown
    """
    ...
    def initialize(self):
        ...
        self.top_n = 3
        self.lookback = 21  # 1 month - faster
