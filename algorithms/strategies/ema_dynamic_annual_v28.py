...
class EMADynamicAnnualV28(QCAlgorithm):
    """
    V28: V27 + PROFIT TAKING

    V27 achieved 35.4% CAGR with 52% DD. Adding profit taking to reduce DD:
    - Same semi-annual refresh, top decile volatility
    - Take 50% profit at 50% gain
    - 15% trailing stop after profit take

    Target: 28%+ CAGR with <45% DD
    """
    ...
    def initialize(self):
        ...
        # Profit taking
        self.profit_take_threshold = 0.50
