...
class EMADynamicAnnualV33(QCAlgorithm):
    """
    V33: V30 WITH LOOSER TRAILING STOP + 6 POSITIONS

    V30 had 28.6% CAGR, 40.7% DD with 25% trailing stop.
    Trying to push CAGR above 30% while keeping DD under 45%:
    - 30% trailing stop (let winners run more)
    - 6 positions at 18% each (108% exposure)

    Target: 32%+ CAGR with <45% DD
    """
    ...
    def initialize(self):
        ...
        # 6 positions with slight leverage
