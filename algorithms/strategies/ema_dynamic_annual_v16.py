...
class EMADynamicAnnualV16(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V16 LOOSER DD CONTROL

    V10's DD control was too aggressive. Loosening thresholds:
    - 6 positions at 18% each = 108% exposure
    - DD control: reduce at 25%, exit at 35% (was 15%/25%)
    - Re-entry at 15%
    ...
    def initialize(self):
        ...
        self.dd_reduce_threshold = 0.25  # Was 0.15
        self.dd_exit_threshold = 0.35    # Was 0.25
        self.dd_reentry_threshold = 0.15 # Was 0.08
    ...
    def on_data(self, data):
        ...
        # DD control with LOOSER thresholds
