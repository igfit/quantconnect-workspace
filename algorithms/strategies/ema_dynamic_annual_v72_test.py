...
class EMADynamicAnnualV72Test(QCAlgorithm):
    """
    V72: V71 but FORCE regime to SPECULATIVE_BULL always

    If this works, the issue is regime detection.
    If this fails, the issue is in the if/elif volatility structure itself.
    """
    ...
    def initialize(self):
        ...
        # Force regime to always be SPECULATIVE_BULL
        self.current_regime = "SPECULATIVE_BULL"
    ...
    def coarse_filter(self, coarse):
        # NO regime updates - keep SPECULATIVE_BULL always
    ...
    def fine_filter(self, fine):
        ...
        regime = self.current_regime  # Always "SPECULATIVE_BULL"
        ...
        for x in fine:
            try:
                ...
                # Skip QUALITY_BULL filters since regime is always SPECULATIVE_BULL
        ...
        # Still use if/elif structure but regime is always SPECULATIVE_BULL
        if regime == "QUALITY_BULL":
            if len(vols) >= 10:
