...
class EMADynamicAnnualV40(QCAlgorithm):
    """
    V40: LOWER VOLATILITY THRESHOLD

    Instead of top decile (90th percentile) volatility, use top quintile (80th).
    This should reduce portfolio volatility while maintaining momentum exposure.

    Same as V34 but with 80th percentile volatility filter.
    ...
    def initialize(self):
        ...
        self.weight_per_stock = 0.19

        self.ema_fast = 20
        self.ema_slow = 100
        self.trailing_stop_pct = 0.30

        # Lower volatility percentile
        self.vol_percentile = 80  # Was 90
    ...
    def fine_filter(self, fine):
        ...
        if len(vols) >= 10:
            # 80th percentile instead of 90th
