"""
v12 Test: Higher Slippage Only (0.2% vs 0.1%)

Isolate impact of slippage assumption.
"""

from AlgorithmImports import *


class V12TestSlippage(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # CHANGE: Higher slippage (0.2% instead of 0.1%)
