"""
v12 Out-of-Sample Test - 2015-2019
Testing strategy on data it was NOT developed on.
"""

from AlgorithmImports import *


class V12OOS20152019(QCAlgorithm):

    def initialize(self):
        # OUT-OF-SAMPLE: 2015-2019 (before development period)
        ...
        # Same universe - testing if stocks existed in this period
        ...
        self.log(f"OOS Universe size: {len(self.symbols)} stocks")
