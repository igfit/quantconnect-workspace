"""
v12 ISOLATED TEST: Slippage Only
Same as original but with 0.2% slippage instead of 0.1%
"""

from AlgorithmImports import *


class V12TestSlippageOnly(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # CHANGED: Higher slippage (0.2% instead of 0.1%)
        self.set_security_initializer(lambda security: security.set_slippage_model(
            ConstantSlippageModel(0.002)
        ))
        self.set_brokerage_model(BrokerageName.INTERACTIVE_BROKERS_BROKERAGE)

        # Strategy parameters - SAME AS ORIGINAL
        self.lookback_days = 126
        self.accel_period = 21
        self.top_n = 8
        self.min_dollar_volume = 5_000_000  # ORIGINAL

        # Universe selection parameters - SAME AS ORIGINAL
        self.universe_size = 50
        self.min_market_cap = 2e9
        self.max_market_cap = 500e9
        self.min_price = 10  # ORIGINAL
        self.min_avg_dollar_volume = 20e6  # ORIGINAL
