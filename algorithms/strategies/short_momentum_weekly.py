...
class ShortMomentumWeekly(QCAlgorithm):
    """
    Round 11 Strategy 2: Short Momentum + Weekly Rebalance

    THESIS: 3-month momentum with weekly rebalance for faster rotation.

    WHY IT MIGHT WORK:
    - Short momentum responds to recent trends
    - Weekly rebalance catches breakouts faster
    - More opportunities to rotate into winners
