...
class WaveEWO_COIN(QCAlgorithm):
    """
    Wave-EWO on COIN - Testing crypto exchange stock
    Note: COIN IPO was April 14, 2021
    """

    def initialize(self):
        self.set_start_date(2021, 4, 15)  # Day after IPO
