...
class EMADynamicAnnualV74Test(QCAlgorithm):
    """
    V74: V73 but initialize current_regime to SPECULATIVE_BULL

    Hypothesis: Initial regime being QUALITY_BULL causes issues
    """
    ...
    def initialize(self):
        ...
        # Initialize to correct regime for 2020!
