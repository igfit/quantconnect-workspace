...
class EMADynamicAnnualV36(QCAlgorithm):
    """
    V36: V34 + PORTFOLIO DD CONTROL

    V34 achieved 30.7% CAGR with 44.2% DD.
    Adding portfolio-level DD control:
    - Reduce to 3 positions when DD > 20%
    - Exit all when DD > 30%
    - Re-enter when DD < 12%
