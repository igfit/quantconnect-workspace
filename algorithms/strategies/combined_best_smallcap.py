...
class CombinedBestSmallCap(QCAlgorithm):
    """
    Combined Best DD Reduction - Small/Mid Cap Universe

    Tests if DD reduction techniques work without TSLA/NVDA/MSTR bias.
    Combines:
    - Momentum acceleration filter
    - Drawdown-based position scaling
    - All conservative risk controls
    """
