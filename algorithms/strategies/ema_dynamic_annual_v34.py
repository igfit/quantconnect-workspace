...
class EMADynamicAnnualV34(QCAlgorithm):
    """
    V34: PUSH TO 30%+ CAGR

    V33 achieved 29.4% CAGR with 42.9% DD - very close!
    Increasing exposure slightly to push over 30% CAGR:
    - 30% trailing stop
    - 6 positions at 19% each (114% exposure)
