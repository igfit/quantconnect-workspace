...
class EMADynamicAnnualV9(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V9 MORE LEVERAGE

    Same as V8 but with more leverage:
    - 7 positions at 20% each = 140% exposure
    ...
    def initialize(self):
        ...
        # 7 positions at 20% = 140% exposure
