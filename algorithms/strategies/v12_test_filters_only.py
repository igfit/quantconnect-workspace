"""
v12 ISOLATED TEST: Filters Only
Same as original but with stricter filters ($15 min price, $30M avg volume)
"""

from AlgorithmImports import *


class V12TestFiltersOnly(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.top_n = 8
        # CHANGED: Higher min dollar volume for liquidity
        ...
        # CHANGED: Higher min price
        self.min_price = 15
        # CHANGED: Higher volume requirement
