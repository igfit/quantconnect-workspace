...
class SmallCapDynamicV4(QCAlgorithm):
    """
    V4: Multi-cap momentum - let price momentum select winners

    Key changes:
    - Wider market cap range ($1B - $100B)
    - Select by 3-month price momentum in fine filter
    - More concentrated (3 positions max)
    ...
    def initialize(self):
        ...
        # Universe: wider cap range, very high volume
        self.min_market_cap = 1_000_000_000     # $1B
        self.max_market_cap = 100_000_000_000   # $100B
        self.min_price = 15
        self.min_dollar_volume = 50_000_000     # $50M/day (mega liquid)
        self.universe_size = 15                  # Small universe
    ...
    def coarse_filter(self, coarse):
        ...
        # Filter and calculate 3-month momentum
        filtered = []
        for x in coarse:
    ...
    def rebalance(self):
        ...
        for symbol in self.universe_symbols:
            ...
            if short_mom <= 0.008:  # Lower threshold
                continue
