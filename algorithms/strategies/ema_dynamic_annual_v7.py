...
class EMADynamicAnnualV7(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V7 WIDER STOP + REGIME

    Combines best elements:
    - V5's ultra concentrated 5 positions at 20%
    - V6's ATR stop but WIDER (3x ATR instead of 2x)
    - V3's regime filter (SPY > 200 SMA)

    Target: Balance between CAGR and DD
    """
    ...
    def initialize(self):
        ...
        # WIDER ATR stop
        self.atr_multiplier = 3.0  # 3x instead of 2x
        self.highest_price = {}
