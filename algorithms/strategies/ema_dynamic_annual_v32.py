...
class EMADynamicAnnualV32(QCAlgorithm):
    """
    V32: COMBINED - TRAILING STOP + ADAPTIVE SIZING

    Best of V30 and V31:
    - 20% trailing stop from highest price (tighter than V30's 25%)
    - Adaptive sizing: 22% normal, 15% in high vol
    ...
    def initialize(self):
        ...
        self.base_weight = 0.22     # Normal: 110% exposure
