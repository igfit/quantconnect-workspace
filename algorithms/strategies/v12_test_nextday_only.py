"""
v12 ISOLATED TEST: Next-Day Execution Only
Same as original but with next-day execution instead of same-day
"""

from AlgorithmImports import *


class V12TestNextDayOnly(QCAlgorithm):
