...
class SmallCapV10Dynamic(QCAlgorithm):
    """
    Small-Cap V10 with Dynamic Universe Selection

    Universe Rules (applied monthly):
    - Market Cap: $300M - $10B (small/mid cap)
    - Beta: > 1.3 (high beta)
    - Price: > $5
    - Dollar Volume: > $5M/day
    - Select top 30 by dollar volume

    Strategy: Same as V10 (momentum acceleration + relative strength)
    """
    ...
    def initialize(self):
        ...
        # Momentum parameters (same as V10)
        ...
        # SPY for market regime and beta calculation
        ...
        # Relative strength: top 50%
        self.rs_percentile = 0.50

        # Schedule rebalance and exit checks
        self.schedule.on(
    ...
    def coarse_filter(self, coarse):
        """First pass: liquid stocks with fundamental data"""
    ...
    def fine_filter(self, fine):
        """Second pass: market cap filter (beta calculated dynamically)"""
        if self.is_warming_up:
            return []
        ...
        for x in fine:
            ...
            # Sector filter: focus on growth sectors (tech, consumer discretionary)
            sector = x.asset_classification.morningstar_sector_code
            # Tech (311), Consumer Cyclical (102), Communication (308), Healthcare (206)
            growth_sectors = [311, 102, 308, 206, 310]  # Include Industrials
    ...
    def on_securities_changed(self, changes):
        """Handle universe changes - setup indicators for new stocks"""
        for security in changes.added_securities:
            ...
            # Create indicators using RegisterIndicator for universe securities
    ...
    def calculate_universe_returns(self):
        """Calculate recent returns for relative strength ranking"""
        returns = {}
    ...
    def get_rs_leaders(self):
        """Get top performing stocks by relative strength"""
    ...
    def on_data(self, data):
        ...
        # Track returns for universe stocks
        for symbol in self.universe_symbols:
            ticker = symbol.value
    ...
    def check_exits(self):
        ...
        for ticker in list(self.entry_prices.keys()):
            ...
            # Exit if dropped out of leaders AND in loss
    ...
    def rebalance(self):
        ...
        for symbol in self.universe_symbols:
            ...
            # Must be in top half of performers
