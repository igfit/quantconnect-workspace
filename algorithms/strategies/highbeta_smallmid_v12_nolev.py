"""
High-Beta Small/Mid Cap v12 - NO LEVERAGE variant

Same as v12 but with max_leverage = 1.0 (no leverage)
Testing impact of removing leverage on returns and drawdown.
"""

from AlgorithmImports import *


class HighBetaSmallMidV12NoLev(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # Parameters - NO LEVERAGE
        self.lookback_days = 126
        self.accel_period = 21
        self.top_n = 8
        self.max_leverage = 1.0  # CAPPED AT 1.0
    ...
    def rebalance(self):
        ...
        # NO LEVERAGE - always 1.0 or less
        if above_10 and above_20 and above_50 and qqq_mom_positive:
            leverage = 1.0  # Was 1.15
        elif above_10 and above_20:
            leverage = 1.0  # Was 1.0
        else:
            leverage = 0.8  # Keep defensive scaling
