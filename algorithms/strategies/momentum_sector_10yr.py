...
class MomentumSectorLongPeriod(QCAlgorithm):
    """
    Sector ETF Momentum - Extended Backtest Period (2015-2025)
    Testing if strategy works across different market regimes
    """

    def initialize(self):
        self.set_start_date(2015, 1, 1)  # Extended period
