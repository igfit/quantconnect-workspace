"""
High-Beta Small/Mid Cap v13 - EQUAL WEIGHT variant of v11

v11 achieved: 34.8% CAGR, 0.89 Sharpe, 32.9% DD

Changes:
- Equal weight instead of momentum-weighted (reduce concentration risk)
- Keep all other v11 settings (biweekly, 10 SMA exit, 1.2x leverage)
"""

from AlgorithmImports import *


class HighBetaSmallMidV13(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # Parameters - Same as v11 except equal weight
    ...
    def rebalance(self):
        ...
        # EQUAL WEIGHT (main difference from v11)
        weight_per_stock = leverage / len(top_symbols)
