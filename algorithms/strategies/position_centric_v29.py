...
class PositionCentricV29(QCAlgorithm):
    """
    V29: Position-Centric Optimized (Build on V28 success)

    V28 achieved 17% CAGR, 22.2% DD, 0.665 Sharpe
    Iteration: Try 3 positions instead of 4 for higher concentration
    Keep breakout entry but add volume confirmation
    """
    ...
    def initialize(self):
        ...
        self.max_positions = 3  # More concentrated

        # Entry
        self.entry_mom_6m = 0.28        # Slightly lower to get more entries
        self.entry_adx = 22

        # Exit
        self.trailing_stop_pct = 0.16   # Tighter trailing stop
