...
class EMADynamicAnnualV18(QCAlgorithm):
    """
    EMA Crossover with Dynamic Universe - V18 PROFIT TAKE + REGIME

    Combines V12's profit taking with regime filter:
    ...
    def on_data(self, data):
        ...
        # Bear market - close all and don't trade
        if not bull_market:
