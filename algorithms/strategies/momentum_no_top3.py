"""
Momentum Strategy: No Top 3 Contributors

ROBUSTNESS TEST: Remove NVDA, TSLA, META (top 3 P&L contributors)
Does the strategy still work without the biggest winners?
"""

from AlgorithmImports import *


class MomentumNoTop3(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # ORIGINAL UNIVERSE MINUS TOP 3 PERFORMERS: NVDA, TSLA, META
        self.universe_tickers = [
            # Removed: "NVDA", "TSLA", "META"
