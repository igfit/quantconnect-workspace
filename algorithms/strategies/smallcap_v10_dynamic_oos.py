...
class SmallCapV10DynamicOOS(QCAlgorithm):
    """
    Small-Cap V10 Dynamic - OUT-OF-SAMPLE (2015-2020)

    Same rules as SmallCapV10Dynamic but tested on 2015-2020.
    Universe selected dynamically - no hardcoded tickers.
    """
