...
class EMADynamicAnnualV60QualityTest(QCAlgorithm):
    """
    V60: TEST QUALITY_BULL WITH HIGHER VOLATILITY (2015-2019)

    V59 had 5.57% CAGR. Testing if higher volatility improves returns.

    Changes from V59:
    - Volatility: Top 50% instead of 30-70 percentile
    - Keep quality filters (large cap, profitable, ROE > 10%)

    Hypothesis: In normal bull markets, quality stocks with HIGHER momentum
    and HIGHER volatility should outperform, just not as extreme as bubble.
    """
    ...
    def fine_filter(self, fine):
        ...
        # TOP 50% volatility (instead of 30-70 percentile)
