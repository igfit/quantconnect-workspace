"""
v12 REALISTIC VERSION

Realistic execution model:
1. Generate signals at 3:30 PM (30 min before close)
2. Execute orders at 3:55 PM (5 min before close)
3. Use 0.15% slippage (middle ground)
4. This mimics real MOC (Market-on-Close) orders

This is achievable in practice:
- Run analysis at 3:30 PM
- Place MOC orders by 3:50 PM cutoff
"""

from AlgorithmImports import *


class V12Realistic(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # Realistic slippage: 0.15% (between 0.1% and 0.2%)
        self.set_security_initializer(lambda security: security.set_slippage_model(
            ConstantSlippageModel(0.0015)
        ))
        ...
        # REALISTIC: Generate signals and execute near market close
        # This mimics MOC (Market-on-Close) order flow
        self.schedule.on(
            self.date_rules.every(DayOfWeek.MONDAY),
            self.time_rules.before_market_close("QQQ", 30),  # 3:30 PM
