...
class PositionCentricV37(QCAlgorithm):
    """
    V37: V35 Enhanced (Target 30%+ CAGR)

    Based on V35 (29% CAGR winner) with:
    - Same 15% trailing stop (not tighter - V36 showed tighter hurts)
    - Max leverage 1.75x (up from 1.5x)
    - Slightly lower momentum threshold to get more entries
    """
    ...
    def initialize(self):
        ...
        # Same as V35 mega-cap focus
        self.min_market_cap = 20_000_000_000
        self.max_market_cap = 5_000_000_000_000
        self.min_price = 20
        self.min_dollar_volume = 100_000_000
        self.universe_size = 50
        self.max_positions = 3

        # Slightly lower thresholds for more entries
        self.entry_mom_6m = 0.22               # 22% (was 25%)
        self.entry_mom_3m = 0.08               # 8% (was 10%)

        # Same exit as V35 (tighter hurt V36)
    ...
    def get_leverage_multiplier(self):
        ...
        strong_trend = spy_price > self.spy_sma_200.current.value * 1.05
