...
class PositionCentricV35(QCAlgorithm):
    """
    V35: Leveraged Bull Market (Target 30% CAGR)

    Key changes:
    - Use up to 1.5x leverage in strong bull markets
    - Aggressive position sizing when conditions ideal
    - Focus on highest momentum large-caps
    - Quick exits to protect gains
    """
    ...
    def initialize(self):
        ...
        # Exit
        self.trailing_stop_pct = 0.15  # Tighter trailing
    ...
    def fine_filter(self, fine):
        ...
        # All sectors but focus on mega caps
    ...
    def get_leverage_multiplier(self):
        ...
        # Ideal conditions: SPY above both SMAs and low VIX
        ...
        if above_200 and above_50 and vix < 18:
            ...
            return 0.8  # Reduce exposure in bear markets
    ...
    def daily_signal_check(self):
        ...
        for symbol in list(self.positions.keys()):
            ...
            if abs(current - target_weight) > 0.05:  # Only rebalance if >5% drift
