...
class EMADynamicAnnualV73Test(QCAlgorithm):
    """
    V73: V71 but WITHOUT regime in get_half_year_key

    Hypothesis: Including regime in the cache key causes issues
    """
    ...
    def get_half_year_key(self):
        # NO REGIME in key - just year and half
        year = self.time.year
