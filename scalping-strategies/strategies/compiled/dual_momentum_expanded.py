"""
Dual Momentum Strategy - Expanded Universe

Testing with 6 high-momentum stocks instead of 3
Universe: TSLA, NVDA, AMD + META, GOOGL, AMZN
Hypothesis: More stocks = more opportunities, diversification
Risk: May dilute returns if new stocks underperform
"""

from AlgorithmImports import *


class DualMomentumExpanded(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.lookback = 63  # Keep 3-month lookback
        self.rsi_period = 14
        self.rsi_threshold = 50
        self.trailing_stop_pct = 0.10

        self.position_size_dollars = 15000  # Smaller per position
        ...
        # Expanded universe - 6 high-momentum tech stocks
    ...
    def on_end_of_algorithm(self):
        self.log(f"Dual Momentum Expanded: ${self.portfolio.total_portfolio_value:,.2f}")
