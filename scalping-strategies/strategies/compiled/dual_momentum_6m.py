"""
Dual Momentum Strategy - 6-Month Lookback Variant

Testing longer lookback period (126 trading days vs 63)
Hypothesis: Longer lookback may filter out noise, catch bigger trends
Risk: Slower to react, may miss early momentum shifts
"""

from AlgorithmImports import *


class DualMomentum6M(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.lookback = 126  # 6 months instead of 3
        self.rsi_period = 14
    ...
    def on_end_of_algorithm(self):
        self.log(f"Dual Momentum 6M: ${self.portfolio.total_portfolio_value:,.2f}")
