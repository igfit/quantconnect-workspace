"""
Multi-Timeframe Strategy: Weekly Trend + Daily Entry - TRAINING PERIOD (2018-2020)

Parameters will be validated on test period (2021-2024)
"""

from AlgorithmImports import *


class MTFWeeklyDailyTrain(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.log(f"MTF Weekly-Daily TRAIN (2018-2020): ${self.portfolio.total_portfolio_value:,.2f}")
