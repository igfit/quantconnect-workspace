"""
Dual Momentum VolSize - 5% Trailing Stop

Testing tighter trailing stop (5% vs 10%)
Hypothesis: Tighter stop may lock in more gains but increase whipsaws
"""

from AlgorithmImports import *


class DualMomentumVolSizeStop5(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.trailing_stop_pct = 0.05  # 5% instead of 10%
        self.atr_period = 14
    ...
    def on_end_of_algorithm(self):
        self.log(f"DualMom VolSize 5% Stop: ${self.portfolio.total_portfolio_value:,.2f}")
