"""RSI(3) Entry<25 Exit>55 - Parameter Study"""
from AlgorithmImports import *

class RSI3E25X55(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(3), Entry<25, Exit>55
        self.rsi_period = 3
        self.rsi_entry = 25
        self.rsi_exit = 55
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(3) E<25 X>55: ${self.portfolio.total_portfolio_value:,.2f}")
