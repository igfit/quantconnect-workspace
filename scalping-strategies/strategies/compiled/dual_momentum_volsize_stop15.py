"""
Dual Momentum VolSize - 15% Trailing Stop

Testing wider trailing stop (15% vs 10%)
Hypothesis: Wider stop may capture bigger trends but increase drawdowns
"""

from AlgorithmImports import *


class DualMomentumVolSizeStop15(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.trailing_stop_pct = 0.15  # 15% instead of 10%
        self.atr_period = 14
    ...
    def on_end_of_algorithm(self):
        self.log(f"DualMom VolSize 15% Stop: ${self.portfolio.total_portfolio_value:,.2f}")
