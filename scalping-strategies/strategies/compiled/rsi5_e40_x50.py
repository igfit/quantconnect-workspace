"""RSI(5) Entry<40 Exit>50 - Even looser thresholds for more trades"""
from AlgorithmImports import *

class RSI5E40X50(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(5), Entry<40 (very loose), Exit>50 (very fast)
        self.rsi_period = 5
        self.rsi_entry = 40
        self.rsi_exit = 50
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(5) E<40 X>50: ${self.portfolio.total_portfolio_value:,.2f}")
