"""RSI(5) with Expanded Universe - Test with more high-beta stocks"""
from AlgorithmImports import *

class RSI5ExpandedUniverse(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(5), Entry<35, Exit>55
        self.rsi_period = 5
        self.rsi_entry = 35
        self.rsi_exit = 55

        self.position_size_dollars = 15000  # Smaller per position with more stocks
        ...
        # Expanded universe: high-beta + mega-cap
        self.tickers = ["TSLA", "NVDA", "AMD", "AAPL", "MSFT", "GOOGL"]
        self.symbols = []
        self.indicators = {}
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(5) Expanded Universe: ${self.portfolio.total_portfolio_value:,.2f}")
