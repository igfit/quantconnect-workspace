"""
RSI(5) Optimized Strategy - TEST PERIOD (2021-2022)
...
class RSI5OptimizedTest(QCAlgorithm):

    def initialize(self):
        # TEST PERIOD - Walk-forward validation
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(5) Optimized - TEST PERIOD (2021-2022)")
