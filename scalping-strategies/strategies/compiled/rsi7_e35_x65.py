"""RSI(7) Entry<35 Exit>65 - Parameter Study"""
from AlgorithmImports import *

class RSI7E35X65(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(7), Entry<35, Exit>65
        self.rsi_period = 7
        self.rsi_entry = 35
        self.rsi_exit = 65
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(7) E<35 X>65: ${self.portfolio.total_portfolio_value:,.2f}")
