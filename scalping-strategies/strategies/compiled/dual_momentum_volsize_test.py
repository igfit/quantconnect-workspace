"""
Dual Momentum Vol Sizing - TEST PERIOD (2021-2024)
...
class DualMomentumVolSizeTest(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.log(f"DualMom VolSize TEST: ${self.portfolio.total_portfolio_value:,.2f}")
