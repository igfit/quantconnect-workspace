"""
Dual Momentum Strategy - TEST PERIOD (2021-2024)

Walk-forward validation: Parameters from training applied to out-of-sample data
"""

from AlgorithmImports import *


class DualMomentumTest(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.log(f"Dual Momentum TEST: ${self.portfolio.total_portfolio_value:,.2f}")
