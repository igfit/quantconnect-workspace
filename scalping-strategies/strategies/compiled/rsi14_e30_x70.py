"""RSI(14) Entry<30 Exit>70 - Standard RSI Parameter Study"""
from AlgorithmImports import *

class RSI14E30X70(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(14), Entry<30, Exit>70 (classic RSI settings)
        self.rsi_period = 14
        self.rsi_entry = 30
        self.rsi_exit = 70
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(14) E<30 X>70: ${self.portfolio.total_portfolio_value:,.2f}")
