"""RSI(5) Entry<30 Exit>60 - Parameter Study"""
from AlgorithmImports import *

class RSI5E30X60(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(5), Entry<30, Exit>60
        self.rsi_period = 5
        self.rsi_entry = 30
        self.rsi_exit = 60
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(5) E<30 X>60: ${self.portfolio.total_portfolio_value:,.2f}")
