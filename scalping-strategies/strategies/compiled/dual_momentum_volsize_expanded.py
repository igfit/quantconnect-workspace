"""
Dual Momentum VolSize + Expanded Universe

Combining the two best optimizations:
1. Volatility-adjusted position sizing (best risk-adjusted returns)
2. Expanded 6-stock universe (more opportunities)
...
class DualMomentumVolSizeExpanded(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.atr_period = 14
        self.base_risk_per_trade = 1500  # Slightly smaller for more positions
    ...
    def calculate_position_size(self, symbol, price, atr_value):
        ...
        max_value = self.portfolio.total_portfolio_value * 0.15  # 15% max per position
    ...
    def on_end_of_algorithm(self):
        self.log(f"DualMom VolSize Expanded: ${self.portfolio.total_portfolio_value:,.2f}")
