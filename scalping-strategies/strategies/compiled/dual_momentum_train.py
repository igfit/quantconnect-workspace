"""
Dual Momentum Strategy - TRAINING PERIOD (2018-2020)

Walk-forward validation: Test parameters on out-of-sample data
"""

from AlgorithmImports import *


class DualMomentumTrain(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.log(f"Dual Momentum TRAIN: ${self.portfolio.total_portfolio_value:,.2f}")
