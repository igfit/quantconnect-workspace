"""RSI(5) Entry<35 Exit>55 - Looser thresholds for more trades"""
from AlgorithmImports import *

class RSI5E35X55(QCAlgorithm):
    def initialize(self):
        self.set_start_date(2018, 1, 1)
        self.set_end_date(2024, 12, 31)
        self.set_cash(100000)

        # PARAMS: RSI(5), Entry<35 (looser), Exit>55 (faster)
        self.rsi_period = 5
        self.rsi_entry = 35
        self.rsi_exit = 55
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(5) E<35 X>55: ${self.portfolio.total_portfolio_value:,.2f}")
