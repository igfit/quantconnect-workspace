"""
Dual Momentum VolSize - WITHOUT NVDA (Robustness Test)

CRITICAL TEST: Is the strategy dependent on NVDA's exceptional performance?
If yes, strategy is fragile. If no, strategy is robust.

Universe: TSLA, AMD only (removed NVDA)
"""

from AlgorithmImports import *


class DualMomentumVolSizeNoNVDA(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # ROBUSTNESS TEST: Removed NVDA
        self.tickers = ["TSLA", "AMD"]
        self.symbols = []
        self.indicators = {}
        self.price_history = {}
    ...
    def on_end_of_algorithm(self):
        self.log(f"DualMom VolSize NoNVDA: ${self.portfolio.total_portfolio_value:,.2f}")
