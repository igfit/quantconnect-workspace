"""RSI(5) E<35 X>55 - TEST PERIOD (2021-2022) - Walk-forward validation"""
from AlgorithmImports import *

class RSI5FinalTest(QCAlgorithm):
    def initialize(self):
    ...
    def on_end_of_algorithm(self):
        self.log(f"RSI(5) Final - TEST (2021-2022): ${self.portfolio.total_portfolio_value:,.2f}")
