"""
Dual Momentum VolSize Expanded - TEST (2021-2024)
...
class DualMomentumVolSizeExpandedTest(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.log(f"VolSize Expanded TEST: ${self.portfolio.total_portfolio_value:,.2f}")
