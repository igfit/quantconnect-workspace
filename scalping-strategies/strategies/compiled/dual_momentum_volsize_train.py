"""
Dual Momentum Vol Sizing - TRAINING PERIOD (2018-2020)
...
class DualMomentumVolSizeTrain(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.log(f"DualMom VolSize TRAIN: ${self.portfolio.total_portfolio_value:,.2f}")
